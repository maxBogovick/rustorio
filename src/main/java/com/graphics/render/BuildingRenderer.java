...
final class BuildingRenderer {
    ...
    /** Стороны для стыков труб — статикой, а не {@code Direction.values()}: тот клонирует массив на каждом вызове, а этот цикл идёт на каждое видимое здание каждый кадр (ловушка graphics.md). */
