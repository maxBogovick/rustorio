 ...
 *
 * <p>Ось Y растёт ВНИЗ (как в координатах поля и как на экране в Rust-версии),
 * поэтому {@link #NORTH} имеет смещение {@code dy = -1}. Отрисовка сама
 * переводит это в свою систему координат — домен про экран ничего не знает.
 *
