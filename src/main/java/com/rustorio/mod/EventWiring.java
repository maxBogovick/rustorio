...
public final class EventWiring {
    ...
    /**
     * Publishes {@link WorldInitEvent} once, then wires {@code world}'s four other notification
     * points to publish their own mod-facing event as they fire. Call once, right after
