...
/**
 * What {@link ModLoader#loadAll} produces: the frozen, merged item/building/kind registries, the
 * merged recipe book, and the event bus every loaded mod already subscribed to — everything a game
...
public record LoadedGame(
        ...
        RecipeBook recipes, EventBus events) {
}
