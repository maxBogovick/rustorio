...
class WorldStateHashDeterminismTest {
     ...
     *
     * <p>Updated again: eight new vanilla items in canonicalState()'s per-item totals — same
     * reasoning as WorldReplayTest's latest baseline entry (sand/oil rolls stay after terrain, so
     * the fixture's building layout is unchanged).
     */
